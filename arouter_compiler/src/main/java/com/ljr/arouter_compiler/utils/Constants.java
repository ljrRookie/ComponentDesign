package com.ljr.arouter_compiler.utils;
...
public class Constants {
    //注解处理器中支持的注解类型
    public static final String IROUTER_ANNOTATION_TYPES = "com.ljr.arouter_annotation.ARouter";
    public static final String PARAMETER_ANNOTATION_TYPES = "com.ljr.arouter_annotation.Parameter";
    // 每个子模块的模块名
    ...
    // 包名前缀封装
    public static final String BASE_PACKAGE = "com.ljr.arouter_api";
