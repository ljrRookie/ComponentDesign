...
import com.ljr.arouter_api.core.ARouterLoadGroup;
import com.ljr.arouter_api.core.ARouterLoadPath;
...
public class RouterManager {
    ...
    //Lru缓存，key:组名，value:value:路由组Group对应的详细Path加载接口
    ...
    private String subFromPath2Group(String path) {
        ...
        //从第一个 / 到第二个 / 中间截取，如: /app/MainActivity 截取出 app 作为 group
